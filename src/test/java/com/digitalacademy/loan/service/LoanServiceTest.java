...
public class LoanServiceTest {
    ...
    @DisplayName("Test get info by id equals i should return loan information")
    @Test
    void testGetLoadInfoByIdEquals() throws Exception{
    ...
    @DisplayName("Test get loan by id equals 2 should throw Loan Exception loan info not found")
    @Test
    ...
    @DisplayName("Test get loan info by id equals 2 should throw Exception: Test throw new exception")
    @Test
